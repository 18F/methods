...
The 18F Methods are broken up into the four broad design phases your team is likely to go through during a project. The four phases are [Discover](methods/{{site.baseurl}}/discover), [Decide](methods/{{site.baseurl}}/decide), [Make](methods/{{site.baseurl}}/make), [Validate](methods/{{site.baseurl}}/validate). We provide cards that walk you through the steps of each phase and cards that deal with the [fundamentals](methods/{{site.baseurl}}/fundamentals). While some cards refer to other methods, you may use them independently. You do not need to use all the cards in a section or complete certain tasks before moving on to others. Take whatever cards are most useful to your team and incorporate more tools as you’re ready.
